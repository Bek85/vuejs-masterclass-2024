      ...
      <CardContent>
        ...
        <form class="grid gap-4" @submit.prevent="register">
          ...
          <div class="grid gap-2">
            ...
            <Input id="email" type="email" v-model="formData.email" placeholder="johndoe19@example.com" required />
          </div>
          <div class="grid gap-2">
            <Label id="password" class="text-left">Password</Label>
            <Input id="password" type="password" v-model="formData.password" placeholder="*****" autocomplete
              required />
          </div>
          <div class="grid gap-2">
        ...
        <div class="mt-4 text-sm text-center"> Already have an account? <RouterLink to="/login" class="underline"> Login
          </RouterLink>
        </div>
      </CardContent>
    </Card>
